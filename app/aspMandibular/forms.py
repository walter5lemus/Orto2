...
class aspMandibularForm(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'rama_mand_anch_izq_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
			'rama_mand_anch_der_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
			...
			'rama_mand_altur_izq_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
			'rama_mand_altur_der_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
			...
			'cuerpo_mand_altur_izq_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
			'cuerpo_mand_altur_der_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
			...
			'cuerpo_mand_long_izq_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
			'cuerpo_mand_long_der_altura': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{2}','title':'Solo valores enteros','min':0,'max': 2147483647}),
