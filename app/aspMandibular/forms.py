...
class aspMandibularForm(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'rama_mand_anch_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
			'rama_mand_anch_der_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
			...
			'rama_mand_altur_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
			'rama_mand_altur_der_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
			...
			'cuerpo_mand_altur_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
			'cuerpo_mand_altur_der_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
			...
			'cuerpo_mand_long_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
			'cuerpo_mand_long_der_aspect_observ':forms.TextInput(attrs={'class':'form-control'}),
		}
...
class aspMandibularForm_consultar(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'rama_mand_anch_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
			'rama_mand_anch_der_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
			...
			'rama_mand_altur_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
			'rama_mand_altur_der_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
			...
			'cuerpo_mand_altur_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
			'cuerpo_mand_altur_der_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
			...
			'cuerpo_mand_long_izq_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
			'cuerpo_mand_long_der_aspect_observ':forms.TextInput(attrs={'class':'form-control','readonly':True}),
		}
