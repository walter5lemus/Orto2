...
class aspectos_mandibulares1(models.Model):
	...
	rama_mand_anch_izq_aspect_observ = models.TextField( null=False, blank=False)
	rama_mand_anch_der_aspect_observ = models.TextField( null=False, blank=False)
	...
	rama_mand_altur_izq_aspect_observ = models.TextField(null=False, blank=False)
	rama_mand_altur_der_aspect_observ = models.TextField(null=False, blank=False)
	...
	cuerpo_mand_altur_izq_aspect_observ = models.TextField(null=False, blank=False)
	cuerpo_mand_altur_der_aspect_observ = models.TextField(null=False, blank=False)
	...
	cuerpo_mand_long_izq_aspect_observ = models.TextField(null=False, blank=False)
	cuerpo_mand_long_der_aspect_observ = models.TextField(null=False, blank=False)
