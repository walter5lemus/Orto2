    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipoPerfiltotal', models.IntegerField(choices=[(1, b'Ortogn\xc3\xa1tico'), (2, b'Divergente Anterior'), (3, b'Divergente Posterior')])),
                ('perfilTercio_inferior', models.IntegerField(choices=[(1, b'Recto'), (2, b'C\xc3\xb3ncavo'), (3, b'Convexo')])),
                ...
                ('tamanoLabios', models.IntegerField(choices=[(1, b'Grande'), (3, b'Peque\xc3\xb1a'), (2, b'Mediana')])),
                ('tipoNariz', models.IntegerField(choices=[(1, b'Grande'), (3, b'Peque\xc3\xb1a'), (2, b'Mediana')])),
