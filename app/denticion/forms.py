...
class denticionForm(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'diastemas': forms.TextInput(attrs={'class':'form-control'}),
			'mal_posiciones': forms.TextInput(attrs={'class':'form-control'}),
			'supernumerarios': forms.TextInput(attrs={'class':'form-control'}),
...
class denticionForm_consultar(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'diastemas': forms.TextInput(attrs={'class':'form-control','readonly':True}),
			'mal_posiciones': forms.TextInput(attrs={'class':'form-control','readonly':True}),
			'supernumerarios': forms.TextInput(attrs={'class':'form-control','readonly':True}),
