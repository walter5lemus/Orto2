    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condilo_mand_aspectos_observados', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('eminencia_aspectos_observados', models.CharField(blank=True, max_length=50, null=True)),
                ('espacio_articular_simetrico', models.IntegerField(choices=[(1, b'Sim\xc3\xa9trico'), (2, b'Asim\xc3\xa9trico')], default=1)),
                ('espacio_articular_aspectos_observados', models.CharField(blank=True, max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aspectos_sinusales_simetrico', models.BooleanField(choices=[(True, 'Simetr\xeda'), (False, 'Asimetr\xeda')], default=True)),
                ...
                ('ord_ori_simetrico', models.BooleanField(choices=[(True, 'Simetr\xeda'), (False, 'Asimetr\xeda')], default=True)),
                ...
                ('fpgd_fpgi_simetrico', models.BooleanField(choices=[(True, 'Simetr\xeda'), (False, 'Asimetr\xeda')], default=True)),
                ...
                ('veloc_erup_simetrico', models.BooleanField(choices=[(True, 'Simetr\xeda'), (False, 'Asimetr\xeda')], default=True)),
