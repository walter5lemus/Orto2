...
class AspectosArticularesForm(forms.ModelForm):
	class Meta:
		...
		widgets={
			...
			'condilo_mand_izq_alto':forms.NumberInput(attrs={'class':'form-control','min':1,'max': 2147483647}),
			'condilo_mand_izq_ancho':forms.NumberInput(attrs={'class':'form-control','min':1,'max': 2147483647}),
			'condilo_mand_der_alto':forms.NumberInput(attrs={'class':'form-control','min':1,'max': 2147483647}),
			'condilo_mand_der_ancho':forms.NumberInput(attrs={'class':'form-control','min':1,'max': 2147483647}),
			...
			'eminencia_izq':forms.NumberInput(attrs={'class':'form-control','min':1,'max': 2147483647}),
			'eminencia_der':forms.NumberInput(attrs={'class':'form-control','min':1,'max': 2147483647}),
...
class aspectos_mandibulares2Form(forms.ModelForm):
	class Meta:
		...
		widgets = {
			...
			'aspectos_sinusales_izq_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
			'aspectos_sinusales_der_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
			'ord_ori_simetrico': forms.RadioSelect,
			'ord_ori_izq_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
			'ord_ori_der_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
			'fpgd_fpgi_simetrico': forms.RadioSelect,
			'fpgd_fpgi_izq_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
			'fpgd_fpgi_der_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
			'veloc_erup_simetrico': forms.RadioSelect,
			'veloc_erup_izq_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
			'veloc_erup_der_aspect_observ': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
...
class secuencia_y_cronologiaForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			...
			'fichas': forms.HiddenInput(attrs={'class': 'form-control'}),
			'o_1_1': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_1_2': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_1_3': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_1_4': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_1_5': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_1_6': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_1_7': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_1_8': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_1': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_2': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_3': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_4': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_5': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_6': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_7': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_2_8': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_1': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_2': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_3': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_4': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_5': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_6': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_7': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_3_8': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_1': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_2': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_3': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_4': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_5': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_6': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_7': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
			'o_4_8': forms.NumberInput(attrs={'class': 'form-control', 'max': 8}),
