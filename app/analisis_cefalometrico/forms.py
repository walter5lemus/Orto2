...
class analisis_cefalometricoForm(forms.ModelForm):
	class Meta:
		...
		labels = {
			...
			'profundidad_maxilar': 'Profundidad maxilar',
		...
		widgets = {
			...
			'sna': forms.NumberInput(attrs={'class':'form-control','pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'snb': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'anb': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','readonly':True}),
			'convexidad': forms.NumberInput(attrs={'class':'form-control', 'step': 0.1,'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'wits': forms.NumberInput(attrs={'class':'form-control', 'step': 0.1,'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'long_cuerpo_mandibular': forms.NumberInput(attrs={'class':'form-control', 'step': 0.1,'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'profundidad_maxilar': forms.NumberInput(attrs={'class':'form-control','pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'profundidad_facial': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'plano_mandibular': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'eje_y_fh': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'cono_facial': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'eje_facial': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'angulo_goniaco_superior': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'angulo_goniaco_inferior': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'angulo_goniaco_total': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'is_na': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'is_sn': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'isfh': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'impa': forms.NumberInput(attrs={'class':'form-control', 'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'protusion_de_incisivo_max': forms.NumberInput(attrs={'class':'form-control', 'step': 0.1,'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
			'protusion_de_incisivo_md': forms.NumberInput(attrs={'class':'form-control', 'step': 0.1,'pattern':'[0-9]{11}','title':'Solo se permiten números','min':0,'max': 2147483647}),
