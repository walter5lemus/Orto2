...
urlpatterns = [
	...
	url(r'^moyersinferior/nuevo/(?P<codi>[0-9]{4}(.).*?((?:[a-z][a-z0-9_]*)?))/(?P<num>\d+)/$', moyersinf_view,name='moyersinferior_crear'),
    url(r'^moyersinferior/editar/(?P<codi>[0-9]{4}(.).*?((?:[a-z][a-z0-9_]*)?))/(?P<num>\d+)/$', moyersinf_editar,name='oyersinferior_editar'),
    url(r'^moyersinferior/consultar/(?P<codi>[0-9]{4}(.).*?((?:[a-z][a-z0-9_]*)?))/(?P<num>\d+)/$', moyersinf_consultar,name='oyersinferior_consultar'),
]